...
public class AuthService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret) {
        ...
        if(authToken == null){
            ExceptionCast.cast(ErrorEnum.LOGIN_FAIL);
        }
        //用户身份令牌
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret){
        ...
        ServiceInstance serviceInstance = loadBalancerClient.choose("shiying-service-auth");
        //此地址就是http://ip:port
        ...
        if(bodyMap == null ||
            ...
            if(bodyMap!=null && bodyMap.get("error_description")!=null){
                ...
                if(error_description.indexOf("UserDetailsService returned null")>=0){
                    ExceptionCast.cast(ErrorEnum.USERNAME_NOT_FOUND);
                }else if(error_description.indexOf("用户名或密码错误")>=0){
                    ExceptionCast.cast(ErrorEnum.USERNAME_OR_PASSWORD_WRONG);
                }
            }
